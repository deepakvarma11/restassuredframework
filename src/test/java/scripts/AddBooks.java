	...
	public void addBooks() {
		...
		if (bookAddedStatusCode == res.getStatusCode()) {
			...
			ExtentTestManager.getTest().log(Status.PASS,
					methodName + " is Passed as the Book added Successfully Passed and the Expected Status "
							+ bookAddedStatusCode + " and Actual Status : " + res.getStatusCode());
			...
			ExtentTestManager.getTest().log(Status.FAIL, methodName
					+ " is Failed may be due the User is not authorized or Error occurred and Expected status is "
